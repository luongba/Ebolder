<template>
    <div class="bg-white p-3 flex flex-column md:rounded min-h-full" style="min-height: 100%;">
        <div class="font-bold text-xl mb-4"> Questions</div>
        <div class="flex flex-column justify-between flex-grow" v-show="this.questions?.length > 0">
            <div>
