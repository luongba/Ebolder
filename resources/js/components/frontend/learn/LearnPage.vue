                  ...
                  <div class="flex justify-center mt-4">
                    ...
                    >
                      <div
                        ...
                        :class="
                          findLevel(item.id) && findLevel(item.id).is_done_listen &&
                    ...
                    >
                      <div
                        ...
                        class="p-3 border text-[#fff] text-[20px] leading-[1] hover:bg-white hover:text-[#000] rounded-sm mx-2 exam"
                        :class="
                          findLevel(item.id) && findLevel(item.id).is_done_read &&
                    ...
                    >
                      <div
                        ...
                        class="p-3 border text-[#fff] text-[20px] leading-[1] hover:bg-white hover:text-[#000] rounded-sm mx-2 exam"
                        :class="
                          findLevel(item.id) && findLevel(item.id).is_done_vocabulary &&
                    ...
                    >
                      <div
                        ...
                        class="p-3 border text-[#fff] text-[20px] leading-[1] hover:bg-white hover:text-[#000] rounded-sm mx-2 exam"
                        :class="
                          findLevel(item.id) && findLevel(item.id).is_done_grammar &&
