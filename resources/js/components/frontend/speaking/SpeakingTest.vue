      ...
      if (this.request.exam) {
        try {
          ...
          if (result.data.status === 200) {
            window.location.href = `${$Api.baseUrl}/exam/result/${this.request.historyId}&v=${this.request.v}&g=${this.request.g}&l=${this.request.l}&s=${this.request.s}&r=${this.request.r}&historyId=${this.request.historyId}&examId=${this.request.examId}&exam=true`;
          }
        } catch (error) {}
      }
