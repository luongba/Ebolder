<template>
    ...
    >
        <path
            fill="#000"
            d="M23.4,107.3h4.3c1.5,0,2.6-1.2,2.6-2.6v-0.2c0-1.5-1.2-2.6-2.6-2.6h-4.3c-1.5,0-2.6,1.2-2.6,2.6v0.2
	...
	"
        ...
        <path
            fill="#000"
            d="M58.4,92.2h6.4c1.5,0,2.6-1.2,2.6-2.6v-0.2c0-1.5-1.2-2.6-2.6-2.6h-6.4c-1.5,0-2.6,1.2-2.6,2.6v0.2
	C55.7,91,56.9,92.2,58.4,92.2z"
        />
        <path
            fill="#000"
            d="M79.1,121.7c1.5,0,2.6-1.2,2.6-2.6v-0.2c0-1.5-1.2-2.6-2.6-2.6H70c-1.5,0-2.6,1.2-2.6,2.6v0.2
	c0,1.5,1.2,2.6,2.6,2.6H79.1z"
        />
        <path
            fill="#000"
            d="M128.4,197.1c-12.8,0-23.4-3.5-31.5-10.4c-8.2-7-12.3-18-12.3-32.7v-45.6c0-14.7,4.1-25.7,12.3-32.7
	...
	C150.3,73.2,140.4,70.3,128.4,70.3z"
        ...
        <path
            fill="#000"
            d="M14.3,133.2L14.3,133.2c0-1.5-1.2-2.6-2.6-2.6s-2.6,1.2-2.6,2.6v0c0,1.5,1.2,2.6,2.6,2.6
