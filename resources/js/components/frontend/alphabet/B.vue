<template>
    ...
    >
        <path
            fill="#FF6F61"
            d="M238.8,145.8h-43.4c-1.5,0-2.6,1.2-2.6,2.6v0.2c0,1.5,1.2,2.6,2.6,2.6h43.4c1.5,0,2.6-1.2,2.6-2.6v-0.2
	C241.4,147,240.2,145.8,238.8,145.8z"
        />
        <path
            fill="#FF6F61"
            d="M179,148.4c0-1.5-1.2-2.6-2.6-2.6h-4.8c0.2,1.7,0.4,3.5,0.4,5.5h4.4c1.5,0,2.6-1.2,2.6-2.6V148.4z"
        />
        <path
            fill="#FF6F61"
            d="M134.6,136c0.3,0.1,0.6,0.2,1,0.2C135.3,136.1,135,136.1,134.6,136z"
        />
        <path
            fill="#FF6F61"
            d="M167.6,134.8c0,0,0,0.1,0.1,0.1c0.2-0.4,0.4-0.8,0.4-1.3v-0.2c0-1.5-1.2-2.6-2.6-2.6h-1.7
	C165.2,132,166.5,133.3,167.6,134.8z"
        />
        <path
            fill="#FF6F61"
            d="M185.7,136.2h7.1c1.5,0,2.6-1.2,2.6-2.6v-0.2c0-1.5-1.2-2.6-2.6-2.6h-7.1c-1.5,0-2.6,1.2-2.6,2.6v0.2
	C183.1,135,184.3,136.2,185.7,136.2z"
        />
        <path
            fill="#FF6F61"
            d="M191.2,120.4h21.5c1.5,0,2.6-1.2,2.6-2.6v-0.2c0-1.5-1.2-2.6-2.6-2.6h-21.5c-1.5,0-2.6,1.2-2.6,2.6v0.2
	C188.6,119.3,189.8,120.4,191.2,120.4z"
        ...
        <path
            fill="#FF6F61"
            d="M195.4,176.6h-4.5v-4.5c0-1.5-1.2-2.6-2.6-2.6H188c-1.5,0-2.6,1.2-2.6,2.6v4.5h-4.5c-1.5,0-2.6,1.2-2.6,2.6
	...
	C198,177.8,196.8,176.6,195.4,176.6z"
        ...
        <path
            fill="#FF6F61"
            d="M137.5,196.1H99.3c-4.1,0-7.5-1-10-2.9c-3.4-2.6-4.2-5.6-4.2-7.7V76.1c0-3.5,1.6-6.3,4.6-8.2
