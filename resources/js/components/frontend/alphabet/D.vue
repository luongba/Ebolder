<template>
    ...
    >
        <path
            fill="#B565A7"
            d="M128.2,196.1H97.7c-4,0-7.3-1-9.9-2.9c-3.5-2.6-4.3-5.6-4.3-7.7V75.9c0-2.1,0.7-5.1,4.3-7.7
	...
	V153C146.2,169.2,136.4,172.7,128.2,172.7z M115.4,167.7h12.8c8.9,0,13-4.7,13-14.7v-44.5c0-10-4.1-14.7-13-14.7h-12.8V167.7z"
        ...
        <path
            fill="#B565A7"
            d="M156,188.4c1.5,0,2.7-1.2,2.7-2.7c0-0.5-0.2-1-0.4-1.4c-2,1.6-4.1,3-6.3,4.2H156z"
        />
        <path
            fill="#B565A7"
            d="M218.4,182.9h-18.5c-1.5,0-2.7,1.2-2.7,2.7s1.2,2.7,2.7,2.7h18.5c1.5,0,2.7-1.2,2.7-2.7
	S219.9,182.9,218.4,182.9z"
        />
        <path
            fill="#B565A7"
            d="M176.6,188.4h6.9c1.5,0,2.7-1.2,2.7-2.7s-1.2-2.7-2.7-2.7h-6.9c-1.5,0-2.7,1.2-2.7,2.7
	S175.1,188.4,176.6,188.4z"
        />
        <path
            fill="#B565A7"
            d="M206.1,201.4c0-1.5-1.2-2.7-2.7-2.7h-21.3c-1.5,0-2.7,1.2-2.7,2.7c0,1.5,1.2,2.7,2.7,2.7h21.3
	C204.8,204.2,206.1,203,206.1,201.4z"
        />
        <path
            fill="#B565A7"
            d="M158.6,198.7c-1.5,0-2.7,1.2-2.7,2.7c0,1.5,1.2,2.7,2.7,2.7h2.3c1.5,0,2.7-1.2,2.7-2.7
	c0-1.5-1.2-2.7-2.7-2.7H158.6z"
        />
        <path
            fill="#B565A7"
            d="M72.9,104.2V104c0-1.5-1.2-2.6-2.6-2.6h-4.5v-4.5c0-1.5-1.2-2.6-2.6-2.6h-0.2c-1.5,0-2.6,1.2-2.6,2.6v4.5
	...
	C71.7,106.9,72.9,105.7,72.9,104.2z"
        ...
        <path
            fill="#B565A7"
            d="M110.1,58.5c4.5,0,8.2-3.7,8.2-8.2c0-4.5-3.7-8.2-8.2-8.2c-4.5,0-8.2,3.7-8.2,8.2
