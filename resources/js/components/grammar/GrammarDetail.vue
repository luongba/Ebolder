...
export default {
    ...
    methods: {
        ...
        async getDetailTopic() {
            try {
                let rs = await axios.get(
                    `${$Api.baseUrlApi}/admin/detail-topic-grammar/${this.param}`
                );
                if (rs.data.status == 200) {
        ...
        async getAllQuestion() {
            try {
                let { data } = await axios.get(
                    `${$Api.baseUrlApi}/admin/list-question-grammar`
                );
        ...
        async addTopic(id) {
            try {
                let { data } = await axios.post(
                    `${$Api.baseUrlApi}/admin/add-question-to-topic-grammar`,
                    {
        ...
        async removeTopic(id) {
            try {
                let { data } = await axios.post(
                    `${$Api.baseUrlApi}/admin/remove-question-from-topic-grammar`,
                    {
                        idTopic: this.detailTopic.id,
                        idQues: id,
                    }
        ...
        async saveChangeTitle(id) {
            try {
                let { data } = await axios.post(
                    `${$Api.baseUrlApi}/admin/edit-topic-grammar`,
                    {
                        id,
