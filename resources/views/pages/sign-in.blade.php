    ...
    <div class="app-container">
        ...
        <div class="h-100">
            <div class="h-100 no-gutters row">
                ...
                <div class="flex items-center h-100 bg-no-repeat" style="background-image: url('images/login/login.png');">
                ...
                <div class="h-100 bg-white col-md-12 col-xl-9 d-flex flex-column ">
                    <div class="p-4 d-flex justify-content-between align-items-center flex-xl-row flex-md-row flex-column">
                        <div class="mb-4">
                            <div class="d-flex flex-row d-xl-none d-md-flex">
                                <img src="/images/login/logo.svg" alt="" />
                                <div class="d-flex justify-content-center flex-column text-body font-weight-bold ml-2">
                                    <p class="m-0">If You Don’t Walk Today</p>
                                    <p class="m-0">You’ll Have To Run Tomorrow.</p>
                                </div>
                            </div>
                    ...
                    <div class="w-100 h-100 d-flex flex-row align-items-center justify-content-center">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-6 col-12 d-flex justify-content-center align-items-center flex-grow-1 flex-column">
                                ...
                                <form id="signupForm" class="" method="post" action="{{route('auth.login')}}">
                                    ...
                                    <div class="d-flex align-items-end flex-column">
                                            <a href="{{route('recover-password')}}" class="btn-link">Recover
                                                Password</a>
                                            <button type="submit" class="btn login-btn dev-submit-button w-100">Sign in
                                            </button>
                                    </div>
                                </form>
                            </div>
