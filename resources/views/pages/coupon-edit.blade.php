        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        Coupon Edit
                        <div class="page-title-subheading">Edit coupon swiftly and win more sales with Ebolder!.</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card-body" style="padding-top: 0rem; padding-left: 0rem; padding-bottom: 2rem">
                            <div class="form-row">
                                <a href="{{route('coupon-home')}}"><button class="mr-3 btn-shadow btn-primary btn-wide float-left btn-pill btn-hover-shine btn dev-submit-button" type="submit">Update </button></a>
