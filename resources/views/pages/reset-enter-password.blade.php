            ...
            <div class="h-100 no-gutters row">
                ...
                <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                    <div class="mx-auto app-login-box col-sm-12 col-md-8 col-lg-6">
                        ...
                        <div>
                            <form id="signupForm" action="{{route('reset-password-token', ["token"=>$token])}}" method="post">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="position-relative form-group">
                                            <label for="password_confirmation" class="">Password Confirmed</label>
                                            <input name="password_confirmation" id="password_confirmation"
                                                   placeholder="Password Confirm" type="password" class="form-control">
                                        </div>
                                    </div>
                                </div>
