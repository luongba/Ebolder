        ...
        <div class="app-header__logo editor-newsletter-head">
            ...
            <div class="editor-newsletter-block-title">
                <div class="editor-newsletter-info" data-toggle="modal" data-target="#editor-newsletter-info-sent">
                    <div class="editor-newsletter-title">Email Newsletter infomati....</div> <span><i class="lnr-pencil" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Newsletter Infomations"></i></span>
                </div>
            </div>
        </div>
        ...
        <div class="app-header__content">
            ...
            <div class="app-header-right">
                <div class="header-dots">
                    ...
                    <a href="{{route('newsletter-config')}}"><button class="mr-2 btn btn-primary next-button editor-button">Next</button></a>
