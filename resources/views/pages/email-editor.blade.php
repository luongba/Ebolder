        ...
        <div class="app-header__logo editor-newsletter-head">
            ...
            <div class="editor-newsletter-block-title">
                <div class="editor-newsletter-info" data-toggle="modal" data-target="#editor-newsletter-info-sent">
                    <div class="editor-newsletter-title">Customer Winback Email Title...</div> <span><i class="lnr-pencil" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Customer Winback Email"></i></span>
                </div>
            </div>
        </div>
        ...
        <div class="app-header__content">
            ...
            <div class="app-header-right">
                <div class="header-dots">
                    ...
                    <button class="mr-2 btn btn-secondary save-button editor-button">Save</button>
                    <a href="{{route('winback-config')}}"><button class="mr-2 btn btn-primary next-button editor-button">Next</button></a>
                ...
                <div class="modal-body">
                    <div class="mb-0">
                        <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                            ...
                            <li class="nav-item">
                                <div class="dropdown d-inline-block">
                                    <a href="newsletter-template-favorites.html"><button type="button" class="mb-2 mr-2 btn btn-dashed btn-outline-primary dev-tab-template-button">
