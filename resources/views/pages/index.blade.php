            ...
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                                    <span class="btn-icon-wrapper pr-2">
                                        <a class="btn-icon btn dev-button btn-primary" href="{{route('campaign-create')}}" style="padding: 10px 15px;">
        ...
        <div class="tabs-animation">
            ...
            <div class="mb-3 card">
                ...
                <div class="text-center d-block p-3 card-footer">
                    <a href="{{route('report')}}"><button class="btn-pill btn-shadow btn-wide fsize-1 btn btn-primary btn-lg">
