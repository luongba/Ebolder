...
@section('content')
    <div class="app-main__inner">
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        Create New Customer Winback Email
                        <div class="page-title-subheading">Create your Customer Winback Email swiftly and win more sales with EBOLDER!.</div>
                    </div>
                </div>
        ...
        <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
            ...
            <li class="nav-item">
                <div class="dropdown d-inline-block">
                    <a href="{{route('winback-favorite')}}"><button type="button" class="mb-2 mr-2 btn btn-dashed btn-outline-primary dev-tab-template-button">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <div class="mb-3 profile-responsive card email-template-main">
                        <div class="template-item-thumbnail" data-toggle="modal" data-target="#create-email-scratch">
...
@section('modal')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Customer Winback Email From Library</h5>
                ...
                <form type="" method="" id="addon-domain">
                    <div class="modal-body">
                        <div class="mb-0">
                            <div class="position-relative form-group">
                                <label for="newsletter-title" class="text-bold">Customer Winback Email Title</label>
                                <input type="text" class="form-control" id="newsletter-title" name="Customer Winback Title" placeholder="Enter Customer Winback Title ..." value="Customer winback title show here">
                            </div>
                            <div class="position-relative form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{route('winback-editor')}}"><button type="button" class="btn btn-primary">Create</button></a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- Modal create customer winback from scratch-->
    <div class="modal fade" id="create-email-scratch"  tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Customer Winback Email From Scratch</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form type="" method="" id="addon-domain">
                    <div class="modal-body">
                        <div class="mb-0">
                            <div class="position-relative form-group">
                                <label for="newsletter-title" class="text-bold">Customer Winback Email Title</label>
                                <input type="text" class="form-control" id="newsletter-title" name="Customer Winback Title" placeholder="Enter Customer Winback Title ..." value="">
                            </div>
                            <div class="position-relative form-group">
                                <label for="subject-email" class="text-bold">Subject Email <i class="fa text-primary fa-question-circle text-secondary" data-toggle="tooltip" data-placement="top" title="" data-original-title="This is subject of email will send to customer "></i></label>
                                <input type="text" class="form-control" id="subject-email" name="subject email" placeholder="Enter Subject Email ..." value="" >
